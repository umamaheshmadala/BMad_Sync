...
import { loginBusiness } from '../api/business'; // Assuming a new API service for business auth
...
const BusinessLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/business-dashboard'); // Redirect to business dashboard after successful login
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 dark:bg-gray-950 p-4 sm:p-6 lg:p-8">
      <div className="bg-gray-800 dark:bg-gray-900 p-8 rounded-lg shadow-xl w-full max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-6xl">
        <h2 className="text-3xl font-extrabold mb-8 text-center text-white dark:text-gray-100">Login to Your Business Account</h2>
